...
- **Content taxonomy population order**: in practice, hand-curated seed content (`backend/.../SeedData.kt`, 28 concepts) now covers Medication, Procedure, Condition, Lab value, Protocol, and abbreviation/brand-name aliases — Equipment and Anatomy remain unpopulated. This is still placeholder content standing in for the real AI-augmentation/corpus-ingestion pipelines (Roadmap Phases 5–6), not the actual curation process.
